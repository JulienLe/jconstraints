...
public class IfThenElse<E> extends AbstractExpression<E> {
  ...
  public IfThenElse(
      Type<E> type, Expression<Boolean> ifCond, Expression<E> thenExpr, Expression<E> elseExpr) {
    this.type = type;
    this.ifCond = ifCond;
  ...
  public static <E> IfThenElse<E> create(
      Expression<Boolean> condition, Expression<E> thenExpr, Expression<E> elseExpr) {
